...
interface ResponseError {
	 ...
	 */
	const TRANSACTION_NOT_FOUND = 003;
	 ...
	 */
	const CARD_DATA_INCOMPATIBLE = 010;
	 ...
	 */
	const PAYMENT_METHOD_INCOMPATIBLE = 011;
	 ...
	 */
	const INSTALLMENTS_INVALID = 012;
	 ...
	 */
	const AUTHORIZATION_INDICATOR_INVALID = 013;
	 ...
	 */
	const DIRECT_AUTHORIZATION_INVALID = 014;
	 ...
	 * Ação: Rever as regras de utilização da Autorização Direta
	 */
	const DIRECT_AUTHORIZATION_WITHOUT_CARD = 015;
	 ...
	 * Ação: Rever a aplicação
	 */
	const TRANSACTION_ID_INVALID = 016;
	 ...
	 */
	const SECURITY_CARD_INDICATOR_INCOMPATIBLE = 018;
	 ...
	 */
	const AUTHORIZATION_NOT_ALLOWED = 020;
	 ...
	 * Ação: Rever as regras de autorização
	 */
	const AUTHORIZATION_EXPIRED = 021;
	 ...
	 * Ação: Rever as regras de autorização
	 */
	const AUTHORIZATION_FORWARD_NOT_ALLOWED = 025;
	 ...
	 * Ação: Rever as regras de captura
	 */
	const CAPTURE_AMOUNT_INVALID = 032;
	 ...
	 */
	const CANCELLATION_EXPIRED = 040;
	 ...
	 * Ação: Rever as regras de cancelamento
	 */
	const CANCELLATION_NOT_ALLOWED = 041;
	 ...
	 */
	const CANCELLATION_AMOUNT_INVALID = 043;
